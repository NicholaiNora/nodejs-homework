...
//prettier-ignore
import { getCurrentUsers, loginUser, logoutUser, resendVerificationEmail, signupUser, updateAvatar, updateUserSubscription, verifyEmail } from "../../controllers/usersControllers.js";
...
router.post("/verify", async (req, res, next) => {
  try {
    const result = await resendVerificationEmail(req, res, next);
    return result;
  } catch (error) {
    next(error);
  }
